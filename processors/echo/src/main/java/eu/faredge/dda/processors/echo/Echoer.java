...
public class Echoer {
    ...
    public static void main(String... args) {
        ...
        configuration.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG,
                String.format("%s:%s", System.getProperty("faredge.input.host", "localhost"),
                        System.getProperty("faredge.input.port", "9092")));
        ...
        builder.stream(System.getProperty("faredge.input.topic"), Consumed.with(Serdes.String(), serde))
