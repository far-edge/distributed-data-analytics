...
const DataInterfaceForm = (props) => {

  // eslint-disable-next-line no-console
  console.log('Render the data interface form.');
  return (
    <Form>
      <Form.Field>
        <label>{ tr('NAME') }</label>
        <Input
          name='name'
          type='text'
          value={ props.dataInterface.name }
      ...
      <Form.Field inline>
        ...
        <TextArea
          name='description'
          value={ props.dataInterface.description }
          onChange={ (e) => { props.onChangeValue(e.target.name, e.target.value); } }
        />
      </Form.Field>
      <Form.Field>
        <label>{ tr('COMMUNICATION_PROTOCOL') }</label>
        <Input
          name='communicationProtocol'
          type='text'
          value={ props.dataInterface.communicationProtocol }
          onChange={ (e) => { props.onChangeValue(e.target.name, e.target.value); } }
        />
      </Form.Field>
      <Segment className='parameters'>
        <div className='title'>{ tr('PARAMETERS') }</div>
        {
          ...
          props.dataInterface.parameters && props.dataInterface.parameters.parameter.map((parameter, i) => {
            return (
              <Form.Group
...
export default DataInterfaceForm;
